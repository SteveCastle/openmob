...
func (s *shrikeServiceServer) CreateField(ctx context.Context, req *v1.CreateFieldRequest) (*v1.CreateFieldResponse, error) {
	...
	err = c.QueryRowContext(ctx, "INSERT INTO field (field_type, component) VALUES($1, $2)  RETURNING id;",
		req.Item.FieldType, req.Item.Component).Scan(&id)
	if err != nil {
...
func (s *shrikeServiceServer) GetField(ctx context.Context, req *v1.GetFieldRequest) (*v1.GetFieldResponse, error) {
	...
	if err := rows.Scan(&field.ID, &createdAt, &updatedAt, &field.FieldType, &field.Component); err != nil {
...
func (s *shrikeServiceServer) ListField(ctx context.Context, req *v1.ListFieldRequest) (*v1.ListFieldResponse, error) {
	...
	baseSQL := "SELECT id, created_at, updated_at, field_type, component FROM field"
...
func (s *shrikeServiceServer) UpdateField(ctx context.Context, req *v1.UpdateFieldRequest) (*v1.UpdateFieldResponse, error) {
	...
	// update field
	res, err := c.ExecContext(ctx, "UPDATE field SET field_type=$2, component=$3 WHERE id=$1",
		req.Item.ID, req.Item.FieldType, req.Item.Component)
	if err != nil {
