...
// BuildEventAttendeeFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildEventAttendeeFilters(filters []*v1.EventAttendeeFilterRule, orderings []*v1.EventAttendeeOrdering, limit int64) string {
	var sql string
