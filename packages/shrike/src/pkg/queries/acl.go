...
// BuildACLFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildACLFilters(filters []*v1.ACLFilterRule, orderings []*v1.ACLOrdering, limit int64) string {
	var sql string
