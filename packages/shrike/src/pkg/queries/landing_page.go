...
// BuildLandingPageFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildLandingPageFilters(filters []*v1.LandingPageFilterRule, orderings []*v1.LandingPageOrdering, limit int64) string {
	var sql string
