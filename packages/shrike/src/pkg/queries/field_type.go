...
// BuildFieldTypeFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildFieldTypeFilters(filters []*v1.FieldTypeFilterRule, orderings []*v1.FieldTypeOrdering, limit int64) string {
	var sql string
