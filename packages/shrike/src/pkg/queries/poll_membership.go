...
// BuildPollMembershipFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildPollMembershipFilters(filters []*v1.PollMembershipFilterRule, orderings []*v1.PollMembershipOrdering, limit int64) string {
	var sql string
