...
// BuildProductMembershipFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildProductMembershipFilters(filters []*v1.ProductMembershipFilterRule, orderings []*v1.ProductMembershipOrdering, limit int64) string {
	var sql string
