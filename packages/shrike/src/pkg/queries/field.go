...
// BuildFieldFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildFieldFilters(filters []*v1.FieldFilterRule, orderings []*v1.FieldOrdering, limit int64) string {
	var sql string
