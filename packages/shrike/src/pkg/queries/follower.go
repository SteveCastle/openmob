...
// BuildFollowerFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildFollowerFilters(filters []*v1.FollowerFilterRule, orderings []*v1.FollowerOrdering, limit int64) string {
	var sql string
