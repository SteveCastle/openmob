...
// BuildLayoutRowFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildLayoutRowFilters(filters []*v1.LayoutRowFilterRule, orderings []*v1.LayoutRowOrdering, limit int64) string {
	var sql string
