...
// BuildLiveEventFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildLiveEventFilters(filters []*v1.LiveEventFilterRule, orderings []*v1.LiveEventOrdering, limit int64) string {
	var sql string
