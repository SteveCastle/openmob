...
// BuildOfficeFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildOfficeFilters(filters []*v1.OfficeFilterRule, orderings []*v1.OfficeOrdering, limit int64) string {
	var sql string
