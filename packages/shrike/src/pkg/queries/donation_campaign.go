...
// BuildDonationCampaignFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildDonationCampaignFilters(filters []*v1.DonationCampaignFilterRule, orderings []*v1.DonationCampaignOrdering, limit int64) string {
	var sql string
