...
// BuildAgentFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildAgentFilters(filters []*v1.AgentFilterRule, orderings []*v1.AgentOrdering, limit int64) string {
	var sql string
