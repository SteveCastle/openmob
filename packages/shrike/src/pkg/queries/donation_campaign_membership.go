...
// BuildDonationCampaignMembershipFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildDonationCampaignMembershipFilters(filters []*v1.DonationCampaignMembershipFilterRule, orderings []*v1.DonationCampaignMembershipOrdering, limit int64) string {
	var sql string
