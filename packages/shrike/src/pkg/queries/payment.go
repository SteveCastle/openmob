...
// BuildPaymentFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildPaymentFilters(filters []*v1.PaymentFilterRule, orderings []*v1.PaymentOrdering, limit int64) string {
	var sql string
