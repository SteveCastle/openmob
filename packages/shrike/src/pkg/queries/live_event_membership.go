...
// BuildLiveEventMembershipFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildLiveEventMembershipFilters(filters []*v1.LiveEventMembershipFilterRule, orderings []*v1.LiveEventMembershipOrdering, limit int64) string {
	var sql string
