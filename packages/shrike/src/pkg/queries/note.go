...
// BuildNoteFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildNoteFilters(filters []*v1.NoteFilterRule, orderings []*v1.NoteOrdering, limit int64) string {
	var sql string
