...
// BuildContactFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildContactFilters(filters []*v1.ContactFilterRule, orderings []*v1.ContactOrdering, limit int64) string {
	var sql string
