...
// BuildPhotoFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildPhotoFilters(filters []*v1.PhotoFilterRule, orderings []*v1.PhotoOrdering, limit int64) string {
	var sql string
