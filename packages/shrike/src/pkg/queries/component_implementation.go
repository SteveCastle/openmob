...
// BuildComponentImplementationFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildComponentImplementationFilters(filters []*v1.ComponentImplementationFilterRule, orderings []*v1.ComponentImplementationOrdering, limit int64) string {
	var sql string
