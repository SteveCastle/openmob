...
// BuildExperimentFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildExperimentFilters(filters []*v1.ExperimentFilterRule, orderings []*v1.ExperimentOrdering, limit int64) string {
	var sql string
