...
// BuildLiveEventTypeFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildLiveEventTypeFilters(filters []*v1.LiveEventTypeFilterRule, orderings []*v1.LiveEventTypeOrdering, limit int64) string {
	var sql string
