...
// BuildBoycottMembershipFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildBoycottMembershipFilters(filters []*v1.BoycottMembershipFilterRule, orderings []*v1.BoycottMembershipOrdering, limit int64) string {
	var sql string
