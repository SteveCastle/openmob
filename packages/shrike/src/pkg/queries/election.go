...
// BuildElectionFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildElectionFilters(filters []*v1.ElectionFilterRule, orderings []*v1.ElectionOrdering, limit int64) string {
	var sql string
