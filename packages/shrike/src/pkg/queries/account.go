...
// BuildAccountFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildAccountFilters(filters []*v1.AccountFilterRule, orderings []*v1.AccountOrdering, limit int64) string {
	var sql string
