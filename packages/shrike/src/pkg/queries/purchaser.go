...
// BuildPurchaserFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildPurchaserFilters(filters []*v1.PurchaserFilterRule, orderings []*v1.PurchaserOrdering, limit int64) string {
	var sql string
