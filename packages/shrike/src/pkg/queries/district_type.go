...
// BuildDistrictTypeFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildDistrictTypeFilters(filters []*v1.DistrictTypeFilterRule, orderings []*v1.DistrictTypeOrdering, limit int64) string {
	var sql string
