...
// BuildVolunteerOpportunityFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildVolunteerOpportunityFilters(filters []*v1.VolunteerOpportunityFilterRule, orderings []*v1.VolunteerOpportunityOrdering, limit int64) string {
	var sql string
