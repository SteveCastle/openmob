...
// BuildTerritoryFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildTerritoryFilters(filters []*v1.TerritoryFilterRule, orderings []*v1.TerritoryOrdering, limit int64) string {
	var sql string
