...
// BuildPetitionMembershipFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildPetitionMembershipFilters(filters []*v1.PetitionMembershipFilterRule, orderings []*v1.PetitionMembershipOrdering, limit int64) string {
	var sql string
