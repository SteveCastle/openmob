...
// BuildActivityFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildActivityFilters(filters []*v1.ActivityFilterRule, orderings []*v1.ActivityOrdering, limit int64) string {
	var sql string
