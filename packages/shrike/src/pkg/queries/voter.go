...
// BuildVoterFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildVoterFilters(filters []*v1.VoterFilterRule, orderings []*v1.VoterOrdering, limit int64) string {
	var sql string
