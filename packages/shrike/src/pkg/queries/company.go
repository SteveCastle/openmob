...
// BuildCompanyFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildCompanyFilters(filters []*v1.CompanyFilterRule, orderings []*v1.CompanyOrdering, limit int64) string {
	var sql string
