...
// BuildLayoutTypeFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildLayoutTypeFilters(filters []*v1.LayoutTypeFilterRule, orderings []*v1.LayoutTypeOrdering, limit int64) string {
	var sql string
