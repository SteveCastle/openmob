...
// BuildVolunteerOpportunityMembershipFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildVolunteerOpportunityMembershipFilters(filters []*v1.VolunteerOpportunityMembershipFilterRule, orderings []*v1.VolunteerOpportunityMembershipOrdering, limit int64) string {
	var sql string
