...
// BuildProductTypeFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildProductTypeFilters(filters []*v1.ProductTypeFilterRule, orderings []*v1.ProductTypeOrdering, limit int64) string {
	var sql string
