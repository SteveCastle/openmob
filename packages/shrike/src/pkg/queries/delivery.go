...
// BuildDeliveryFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildDeliveryFilters(filters []*v1.DeliveryFilterRule, orderings []*v1.DeliveryOrdering, limit int64) string {
	var sql string
