...
// BuildPetitionFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildPetitionFilters(filters []*v1.PetitionFilterRule, orderings []*v1.PetitionOrdering, limit int64) string {
	var sql string
