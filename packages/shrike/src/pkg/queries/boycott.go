...
// BuildBoycottFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildBoycottFilters(filters []*v1.BoycottFilterRule, orderings []*v1.BoycottOrdering, limit int64) string {
	var sql string
