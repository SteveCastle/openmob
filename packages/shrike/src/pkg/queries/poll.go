...
// BuildPollFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildPollFilters(filters []*v1.PollFilterRule, orderings []*v1.PollOrdering, limit int64) string {
	var sql string
