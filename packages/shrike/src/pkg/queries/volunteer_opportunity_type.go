...
// BuildVolunteerOpportunityTypeFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildVolunteerOpportunityTypeFilters(filters []*v1.VolunteerOpportunityTypeFilterRule, orderings []*v1.VolunteerOpportunityTypeOrdering, limit int64) string {
	var sql string
