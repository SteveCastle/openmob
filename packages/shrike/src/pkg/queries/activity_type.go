...
// BuildActivityTypeFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildActivityTypeFilters(filters []*v1.ActivityTypeFilterRule, orderings []*v1.ActivityTypeOrdering, limit int64) string {
	var sql string
