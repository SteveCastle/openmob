...
// BuildLayoutColumnFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildLayoutColumnFilters(filters []*v1.LayoutColumnFilterRule, orderings []*v1.LayoutColumnOrdering, limit int64) string {
	var sql string
