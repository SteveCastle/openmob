...
// BuildContactMembershipFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildContactMembershipFilters(filters []*v1.ContactMembershipFilterRule, orderings []*v1.ContactMembershipOrdering, limit int64) string {
	var sql string
