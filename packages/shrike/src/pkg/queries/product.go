...
// BuildProductFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildProductFilters(filters []*v1.ProductFilterRule, orderings []*v1.ProductOrdering, limit int64) string {
	var sql string
