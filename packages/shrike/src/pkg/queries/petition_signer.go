...
// BuildPetitionSignerFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildPetitionSignerFilters(filters []*v1.PetitionSignerFilterRule, orderings []*v1.PetitionSignerOrdering, limit int64) string {
	var sql string
