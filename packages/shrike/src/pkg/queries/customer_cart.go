...
// BuildCustomerCartFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildCustomerCartFilters(filters []*v1.CustomerCartFilterRule, orderings []*v1.CustomerCartOrdering, limit int64) string {
	var sql string
