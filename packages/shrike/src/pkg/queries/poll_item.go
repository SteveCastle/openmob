...
// BuildPollItemFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildPollItemFilters(filters []*v1.PollItemFilterRule, orderings []*v1.PollItemOrdering, limit int64) string {
	var sql string
