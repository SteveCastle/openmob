...
// BuildAgentMembershipFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildAgentMembershipFilters(filters []*v1.AgentMembershipFilterRule, orderings []*v1.AgentMembershipOrdering, limit int64) string {
	var sql string
