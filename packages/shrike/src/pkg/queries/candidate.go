...
// BuildCandidateFilters takes a filter and ordering object for a cause.
// and returns an SQL string
func BuildCandidateFilters(filters []*v1.CandidateFilterRule, orderings []*v1.CandidateOrdering, limit int64) string {
	var sql string
