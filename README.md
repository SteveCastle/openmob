...
Open Mob is comprised of two core packages. A gRPC API service called
[Shrike](https://github.com/SteveCastle/openmob/tree/master/packages/shrike) and
a GatsbyJS based rendering engine for content and admin ui called
